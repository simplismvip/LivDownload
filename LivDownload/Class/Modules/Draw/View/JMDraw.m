...
- (void)drawRadialGradient:(CGContextRef)context
{
    ...
    CGContextDrawRadialGradient(context, gradient, CGPointMake(170, 284), 0, CGPointMake(165, 289), 150, kCGGradientDrawsAfterEndLocation);
    CGContextDrawRadialGradient(context, gradient, CGPointMake(180, 284), 0, CGPointMake(165, 289), 150, kCGGradientDrawsAfterEndLocation);
